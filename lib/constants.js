...
export const CMS_NAME = "Abstract.";
...
export const TEACHER = "Marciano Planque";
export const TEACHERFN = "Marciano";

// export const THEME_TINT = "#177aa8";
export const THEME_TINT = "#00adff";
